...
public class TalkManager : MonoBehaviour
{
    ...
    {// 스프라이트 0번 리리 / 1번 표지판 // 2번 전투교관
        TalkList.Add( 100 , new string[] { "안녕하세요. 이곳에 오신걸 환영합니다~! \n기본적인 조작법을 가르쳐드리기 위해서 \n 제가 곳곳에 < 표지판 >을 설치해놨습니다!:0", "길을 따라가시면  보이시는 <표지판> 을 꼭 읽어보시고  \n앞에 준비된 훈련을 임해주세요:0"});
        TalkList.Add(101, new string[] { "이곳까지 오시느라 고생많으셨습니다! \n 이제 기본적인 조작은 익혔으니 가장중요한 전투를 배워볼 차례네요:0" });
        TalkList.Add( 200 , new string[] { "어서와라. 나는 전투교관이다 \n앞에서 익힌 조작법을 기반으로 전투를 진행해보겠다. :0", "앞에 있는 허수아비를 장착한 <검>과 <활>로 공격해보도록..  \n충분히 익히고 앞을 지나가야한다:0"});
        ...
        TalkBoxSpriteList.Add(200 + 0, BoxSprite[2]); //리리
